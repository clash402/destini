...
struct Story {
    ...
    mutating func updateCurrentSceneIndex(with choice: Int) {
        let currentScene = getCurrentScene()
        
        if choice == 1 {
            currentSceneIndex = currentScene.choice1Destination
        } else {
            currentSceneIndex = currentScene.choice2Destination
        }
    }
    ...
    func isOver() -> Bool {
        let currentScene = getCurrentScene()
        return currentScene.choice1Destination == 0 ? true : false
    }
}
